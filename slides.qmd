...
Dois países com a **mesma média aritmética** (0,70):

| | Dim. A | Dim. B | Dim. C | Aritmética | Geométrica |
|---|:---:|:---:|:---:|:---:|:---:|
| **País 1** | 0,70 | 0,70 | 0,70 | 0,70 | ? |
| **País 2** | 0,90 | 0,70 | 0,50 | 0,70 | ? |

**Pela média geométrica, qual fica maior?**

. . .

**País 1 = 0,70** · **País 2 ≈ 0,68.** O país **equilibrado** vence: a geométrica **penaliza o desequilíbrio** — uma nota alta não compensa plenamente uma baixa.
